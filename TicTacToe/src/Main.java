...
class JavaExample extends JPanel {
    ...
    public void showWinner() {
        ...
        if (checkForWinner()) {
            ...
            int dialog = JOptionPane.showConfirmDialog(jOptionPane, "Игра завершилась. " + "Победитель: " + playerSign + " ", "Результат",
            ...
            JOptionPane jOptionPane = new JOptionPane();
            int dialog = JOptionPane.showConfirmDialog(jOptionPane, "Ничья", "Результат", JOptionPane.DEFAULT_OPTION);
